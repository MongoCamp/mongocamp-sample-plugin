...
class ResetJob extends Job with LazyLogging {
  ...
  override def execute(context: JobExecutionContext): Unit = {
    val mongoCampPrefix  = ConfigurationService.getConfigValue[String](ConfigKeyAuthPrefix)
    val ignoredDatabases = ConfigurationService.getConfigValue[List[String]]("database.ignored")
